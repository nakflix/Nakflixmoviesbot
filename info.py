...
BOT_TOKEN = environ.get('BOT_TOKEN', '5932921073:AAEKLj9iiAK7HZgqSNu98yJe3_VT0Z94oKQ')
# Bot settings
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001858872654').split()]
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '').split()]
AUTH_USERS = (auth_users + ADMINS) if auth_users else []
auth_channel = environ.get('AUTH_CHANNEL', '-1001858872654')
